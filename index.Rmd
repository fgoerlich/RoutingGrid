...
¿Como paso de las rutas &ndash;distancias/tiempos&ndash; de las celdas a los resultados por municipios &ndash;distancia/tiempo a la oficina más cercana?
...
readxl::read_xlsx(here("data", "03AccesibilidadOficinas_.xlsx"), sheet = "DEGURBA") %>%
...
```{r, echo = FALSE, eval = TRUE, fig.asp = 2/2.1, out.width = "70%", fig.align = "center"}
readxl::read_xlsx(here("data", "05AccesibilidadOficinas_.xlsx"), sheet = "DEGURBA") %>%
...
```{r, echo = FALSE, eval = TRUE, fig.asp = 2/2.1, out.width = "70%", fig.align = "center"}
readxl::read_xlsx(here("data", "05AccesibilidadOficinas_.xlsx"), sheet = "CCAA") %>%
...
```{r, echo = FALSE, eval = TRUE, fig.asp = 2/2.1, out.width = "70%", fig.align = "center"}
readxl::read_xlsx(here("data", "06AccesibilidadOficinas_.xlsx"), sheet = "Municipios") %>%
